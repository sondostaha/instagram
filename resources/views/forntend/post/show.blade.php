            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="card mb-12 box-shadow" style="max-width: 600px;">
                                ...
                                <div class="">
                                    @auth
                                        @if( $post->user_id == auth()->user()->id )
                                            <a class="btn btn-sm btn-outline-danger" href="javascript:void(0)" onclick="if (confirm('{{ __('R_u_sure') }}')) { document.getElementById('delete-{{ $post->id  }}').submit(); } else { return false; }" style="text-decoration: none">
                                                {{ __('Delete') }}
                                            </a>
                        ...
                        <img class="card-img-top" src="{{ asset('images/posts/'. $post->image) }}" alt="Card image cap" style="max-height: 600px;">
                        <div class="card-body">
                            ...
                            @foreach ( $post->comments as $comment)
                                <div class="media text-muted pt-3">
                                    ...
                                    <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray" >
                                        ...
                                        <span class="text-body"><strong>{{ $comment->body }}</strong></span>
                                    </div>
                                </div>
                            @endforeach 
                        </div>
